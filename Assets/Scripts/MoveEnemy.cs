...
public class MoveEnemy : MonoBehaviour {
	...
	void Start () {
		...
		someScale = gameObject.transform.localScale.x;
	}
...
//				 flip first time, skip second
	...
	private void FlipLookDirection(){
		...
		sprite.transform.localScale = new Vector2(someScale, gameObject.transform.localScale.y);
	}


	// attack closest enemy to cookie
